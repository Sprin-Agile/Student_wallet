document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- 4. DATA STATE & LOGIC TÍNH TOÁN (ĐÃ NÂNG CẤP LOCALSTORAGE) ---
    // Kiểm tra xem trong máy đã có dữ liệu cũ chưa, nếu chưa thì dùng data demo
    ...
    form.addEventListener('submit', (e) => {
        ...
        // LƯU DỮ LIỆU VÀO TRÌNH DUYỆT NGAY SAU KHI THÊM
            ...
            datasets: [
                {
                    ...
                    borderRadius: 8,
                    barPercentage: 0.9, // Tăng lên 0.9 (cũ là 0.4) để cột to ra
                    categoryPercentage: 0.8 // Trải rộng cột ra đều khung hình
                },
                {
                    label: 'Tổng Tiền Ra',
                    data: [0], 
                    ...
                    borderRadius: 8,
                    barPercentage: 0.9, // Tăng lên 0.9
                    categoryPercentage: 0.8 
                }
            ]
        },
        // ... giữ nguyên phần options bên dưới ...
        options: {
            responsive: true,
