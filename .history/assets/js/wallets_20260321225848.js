document.addEventListener('DOMContentLoaded', () => {
    // Tự động đồng bộ màu sắc từ index.html
    const savedColor = localStorage.getItem('sw_Color');
    if (savedColor) {
        document.documentElement.style.setProperty('--user-theme', savedColor);
        document.documentElement.style.setProperty('--user-theme-light', savedColor + '1A'); // Thêm độ trong suốt 10%
    }
