...
if (savedColor) {
    ...
    document.documentElement.style.setProperty('--user-theme-light', savedColor + '1A'); // Màu nền nhạt 10%
}
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (savedData) {
        ...
        // Kiểm tra xem có phải người dùng mới từ trang onboarding chuyển qua không
        const isNewAccount = localStorage.getItem('sw_NewAccount');
        
        if (isNewAccount === 'true') {
            // Lấy số dư ban đầu từ onboarding, nếu không nhập thì mặc định là 0
