document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderWallets() {
        ...
        // 3. Tính toán Tổng
        let totalAssets = mainBalance + totalCustomBalance; // Tổng tài sản (Khớp với Tổng Số Dư ở home.js)
        let netWorth = totalAssets - totalDebt;             // Tài sản ròng (Sau khi trừ nợ)
        ...
        // In Ví Chính
        // Lấy icon người dùng đã chọn từ lúc Onboarding
        ...
        document.getElementById('net-worth-val').textContent = formatMoney(netWorth);
        document.getElementById('assets-val').textContent = formatMoney(mainBalance + totalCustomBalance); 
        document.getElementById('debts-val').textContent = formatMoney(totalDebt);
        
        container.innerHTML = ''; // Làm sạch vùng chứa trước khi in
